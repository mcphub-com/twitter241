...
__rapidapi_url__ = 'https://rapidapi.com/davethebeast/api/twitter241'
...
def get_post_comments_v2(pid: Annotated[str, Field(description='')],
                         rankingMode: Annotated[Union[str, None], Field(description='Relevance || Likes || Recency Example: Select...')] = None,
                         count: Annotated[Union[str, None], Field(description='')] = None,
                         cursor: Annotated[Union[str, None], Field(description='')] = None) -> dict:
...
@mcp.tool()
def search_twitter_v2(type: Annotated[str, Field(description=' Example: Select...')],
                      count: Annotated[str, Field(description='')],
...
@mcp.tool()
def search_twitter(type: Annotated[str, Field(description=' Example: Select...')],
                   count: Annotated[str, Field(description='')],
                   query: Annotated[str, Field(description='')],
                   cursor: Annotated[Union[str, None], Field(description='')] = None) -> dict:
    '''Search Twitter (Top, Latest, Videos, Photos and People)'''
...
@mcp.tool()
def get_community_timeline(topicId: Annotated[Union[str, None], Field(description='')] = None,
                           cursor: Annotated[Union[str, None], Field(description='')] = None) -> dict:
...
def get_community_members(communityId: Annotated[str, Field(description='')],
                          cusrsor: Annotated[Union[str, None], Field(description='')] = None) -> dict:
...
def get_community_tweets(communityId: Annotated[str, Field(description='')],
                         searchType: Annotated[str, Field(description='Default or Media Example: Select...')],
                         rankingMode: Annotated[Union[str, None], Field(description='Relevance or Recency or Likes Example: Select...')] = None,
                         count: Annotated[Union[str, None], Field(description='')] = None,
                         cursor: Annotated[Union[str, None], Field(description='')] = None) -> dict:
...
def search_jobs(keyword: Annotated[str, Field(description='')],
                count: Annotated[str, Field(description='')],
                job_location_id: Annotated[Union[str, None], Field(description='Get this value from GET /jobs-locations-suggest (Search Job Locations).')] = None,
                job_location_type: Annotated[Union[str, None], Field(description='onsite,remote,hybrid. One of them or multiple values with comma as seperator')] = None,
                seniority_level: Annotated[Union[str, None], Field(description='intern,entry_level,junior,mid_level,senior,lead,manager,executive. One of them or multiple values with comma as seperator')] = None,
                employment_type: Annotated[Union[str, None], Field(description='full_time,full_time_contract,part_time,contract_to_hire. One of them or multiple values with comma as seperator')] = None,
                cursor: Annotated[Union[str, None], Field(description='')] = None) -> dict:
    '''Search Jobs'''
...
def get_trends_by_location(woeid: Annotated[str, Field(description='This value can be gotten from the Get Available Trends Locations endpoint.')],
                           exclude: Annotated[Union[str, None], Field(description='Setting this value equal to hashtags will remove all hashtags from the response list.')] = None) -> dict:
